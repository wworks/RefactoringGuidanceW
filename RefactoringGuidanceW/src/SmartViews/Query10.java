...
/**
 * SmartView for query 10
 */
public class Query10 extends FilteringAtlasSmartViewScript {

	@Override
	public String getTitle() {
		return "Query 10: Parameters, fields and local variables referenced outside of the selected segment";
	}
...
//QueryLibraryQL WQ = new QueryLibraryQL();
//
//
//QL segment = WQ.getMethodSegmentB(texts.getOffset(), texts.getLength(), new QL(methods) );
////res = QL.query10(segment);
//res = Common.toQ(new QueryLibraryQL().Query10(segment).eval());